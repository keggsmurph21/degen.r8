...
(function (roomController) {
    ...
    roomController.postSit = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var roomId, secret, seatIndex, room, user, passwordHash, player;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    roomId = parseInt(req.params.roomId);
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!room.getSitting().reduce(function (alreadyFound, sittingPlayer) {
                        return alreadyFound || Player_1.Player.eq(player, sittingPlayer);
                    }, false)) {
    ...
    roomController.postBet = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var roomId, secret, room, user, passwordHash, player, betType, raiseBy;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    roomId = parseInt(req.params.roomId);
                ...
                case 1:
                    ...
                    try {
                        room.getRound().makeBet(player, betType, raiseBy);
                    }
                    catch (e) {
                        console.log(e);
                        return [2, res.sendStatus(400)];
