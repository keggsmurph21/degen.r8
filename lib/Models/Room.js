...
(function (Room) {
    ...
    function save(roomId, pokerRoom, secret) {
        return __awaiter(this, void 0, void 0, function () {
            var capacity, numSitting, numStanding, json, db;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        capacity = pokerRoom.getParams().capacity;
                        numSitting = pokerRoom.getSitting().filter(function (p) { return p !== null; }).length;
                        numStanding = pokerRoom.getStanding().filter(function (p) { return p !== null; }).length;
                        json = JSON.stringify(pokerRoom.serialize());
                        return [4, Database_1.connect()];
                    case 1:
                        db = _a.sent();
                        return [4, db.run(UPDATE, secret, capacity, numSitting, numStanding, json, roomId)];
                    case 2:
                        _a.sent();
                        return [2];
                }
    ...
    function create(pokerRoom, secret) {
        return __awaiter(this, void 0, void 0, function () {
            var capacity, numSitting, numStanding, json, db, _a, lastID, changes;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        db = _b.sent();
                        return [4, db.run(INSERT, secret, capacity, numSitting, numStanding, json)];
                    case 2:
