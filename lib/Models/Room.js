...
(function (Room) {
    ...
    function save(roomId, pokerRoom, secret) {
        return __awaiter(this, void 0, void 0, function () {
            var serial, numSitting, sittingJson, numStanding, standingJson, roundJson, db, _a, lastID, changes;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        db = _b.sent();
                        return [4, db.run(UPDATE, secret, serial.minimumBet, serial.useBlinds, serial.bigBlindBet, serial.smallBlindBet, serial.useAntes, serial.anteBet, serial.capacity, serial.autoplayInterval, numSitting, numStanding, sittingJson, standingJson, roundJson, roomId)];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        db = _b.sent();
                        return [4, db.run(INSERT, secret, serial.minimumBet, serial.useBlinds, serial.bigBlindBet, serial.smallBlindBet, serial.useAntes, serial.anteBet, serial.capacity, serial.autoplayInterval, numSitting, numStanding, sittingJson, standingJson, roundJson)];
                    case 2:
                        _a = _b.sent(), lastID = _a.lastID, changes = _a.changes;
                        return [2, lastID];
                }
