...
var Room = (function () {
    ...
    Room.prototype.getParticipant = function (playerId) {
        return this.participants.filter(function (player) { return player.id === playerId; })[0] ||
            null;
    };
    ...
    Room.prototype.makeBet = function (player, bet, raiseBy) {
        if (raiseBy === void 0) { raiseBy = 0; }
        if (this.round === null)
            throw new Error("There is no round!");
        var participant = this.getParticipant(player.id);
        if (participant === null)
