...
exports.MAX_SIZE = 16;
var Table = (function () {
    function Table(size, password) {
        this.size = size;
        this.password = password;
        this.byPosition = {};
        this.players = new Set();
        if (size < exports.MIN_SIZE)
            throw new Errors_1.InvalidStateError("Must have {MIN_SIZE} or more players (got {size})!");
        if (size > exports.MAX_SIZE)
            throw new Errors_1.InvalidStateError("Must have {MAX_SIZE} or fewer players (got {size})!");
