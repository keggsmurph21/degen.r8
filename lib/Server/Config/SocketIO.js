...
function onCreateRoom(socket, userId, data) {
    return __awaiter(this, void 0, void 0, function () {
        var res, params, secret, _a, roomId, room, e_1;
...
function configureSocketIO(server) {
    ...
    io.on("connection", function (socket) { return __awaiter(_this, void 0, void 0, function () {
        var session, userId, roomId, secret;
        var _this = this;
        return __generator(this, function (_a) {
            ...
            socket.on("create-room", function (data) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, onCreateRoom(socket, userId, data)];
                    case 1:
                        _a.sent();
                        return [2];
                }
