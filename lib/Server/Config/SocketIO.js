...
function channelNameFor(roomId) {
...
function broadcastRoomView(io, roomId, room) {
    io["in"](channelNameFor(roomId)).clients(function (err, clients) {
        if (err)
            throw err;
...
function onSit(io, socket, data) {
    return __awaiter(this, void 0, void 0, function () {
        var userId, roomId, secret, seatIndex, room, e_3, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
function onLeave(io, socket, data) {
    return __awaiter(this, void 0, void 0, function () {
        var userId, roomId, secret, room, e_5, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
function onAddBalance(io, socket, data) {
    return __awaiter(this, void 0, void 0, function () {
        var userId, roomId, secret, credit, room, e_7, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
function onFold(io, socket, data) {
    return __awaiter(this, void 0, void 0, function () {
        var userId, roomId, secret, room, e_8, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
function onCall(io, socket, data) {
    return __awaiter(this, void 0, void 0, function () {
        var userId, roomId, secret, room, e_9, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 3:
                    e_9 = _a.sent();
                    res = { error: e_9.message, view: null };
                    socket.emit("room-changed", res);
                    return [3, 4];
                case 4: return [2];
            }
...
function onRaise(io, socket, data) {
    return __awaiter(this, void 0, void 0, function () {
        var userId, roomId, secret, raiseBy, room, e_10, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 3:
                    e_10 = _a.sent();
                    res = { error: e_10.message, view: null };
                    socket.emit("room-changed", res);
                    return [3, 4];
                case 4: return [2];
            }
