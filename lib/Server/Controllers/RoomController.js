...
exports.getRoom = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4, RoomService_1.find(user.id, roomId, secret)];
            case 2:
                room = _a.sent();
                res.render("room", {
                    user: { id: user.id, name: user.name },
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4, RoomService_1.create(user.id, secret, params)];
            case 2:
...
exports.postEnter = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4, RoomService_1.enter(user.id, roomId, secret)];
            case 2:
                _a.sent();
                res.redirect("/room.do");
                return [3, 4];
...
exports.postLeave = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4, RoomService_1.leave(user.id, roomId, secret)];
            case 2:
                _a.sent();
                res.redirect("/room.do");
                return [3, 4];
...
exports.postSit = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4, RoomService_1.sit(user.id, roomId, secret, seatIndex)];
            case 2:
                _a.sent();
                res.redirect("/room.do");
                return [3, 4];
...
exports.postStand = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4, RoomService_1.stand(user.id, roomId, secret)];
            case 2:
                _a.sent();
                res.redirect("/room.do");
                return [3, 4];
...
exports.postStartRound = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4, RoomService_1.startRound(user.id, roomId, secret)];
            case 2:
                _a.sent();
                res.redirect("/room.do");
                return [3, 4];
...
exports.postBet = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4, RoomService_1.makeBet(user.id, roomId, secret, betType, raiseBy)];
            case 2:
                _a.sent();
                res.redirect("/room.do");
                return [3, 4];
...
exports.postAddBalance = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4, RoomService_1.addBalance(user.id, roomId, secret, credit)];
            case 2:
                _a.sent();
                res.redirect("/room.do");
                return [3, 4];
